...
{
  new (message_memory) sobang_navigation::msg::LocalState(_init);
}

void LocalState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sobang_navigation::msg::LocalState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LocalState_message_member_array[2] = {
  {
    ...
    offsetof(sobang_navigation::msg::LocalState, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sobang_navigation::msg::LocalState, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LocalState_message_members = {
  ...
  2,  // number of fields
  sizeof(sobang_navigation::msg::LocalState),
...
get_message_type_support_handle<sobang_navigation::msg::LocalState>()
{
  return &::sobang_navigation::msg::rosidl_typesupport_introspection_cpp::LocalState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sobang_navigation, msg, LocalState)() {
  return &::sobang_navigation::msg::rosidl_typesupport_introspection_cpp::LocalState_message_type_support_handle;
}
